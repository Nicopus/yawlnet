package dk.dtu.compute.se.mdsu.petrinet.diagram.edit.parts;
...
import dk.dtu.compute.se.mdsu.petrinet.diagram.edit.policies.PetrinetTextSelectionEditPolicy;
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PetrinetParserProvider.getParser(PetrinetElementTypes.Transition_2001, getParserElement(),
					PetrinetVisualIDRegistry.getType(
							dk.dtu.compute.se.mdsu.petrinet.diagram.edit.parts.TransitionNameEditPart.VISUAL_ID));
		}
		return parser;
	}
