...
import dk.dtu.compute.se.mdsu.petrinet.diagram.providers.PetrinetParserProvider;
	...
	*/
	public Image getImage(View view) {
		...
		case PetrinetEditPart.VISUAL_ID:
			return getImage("Navigator?Diagram?http://se.compute.dtu.dk/mdsu/petrinet?Petrinet", //$NON-NLS-1$
					PetrinetElementTypes.Petrinet_1000);
		case TransitionEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://se.compute.dtu.dk/mdsu/petrinet?Transition", //$NON-NLS-1$
					PetrinetElementTypes.Transition_2001);
		case PlaceEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://se.compute.dtu.dk/mdsu/petrinet?Place", //$NON-NLS-1$
					PetrinetElementTypes.Place_2002);
		case TokenEditPart.VISUAL_ID:
			return getImage("Navigator?Node?http://se.compute.dtu.dk/mdsu/petrinet?Token", //$NON-NLS-1$
					PetrinetElementTypes.Token_3001);
		case ArcEditPart.VISUAL_ID:
			return getImage("Navigator?Link?http://se.compute.dtu.dk/mdsu/petrinet?Arc", PetrinetElementTypes.Arc_4001); //$NON-NLS-1$
		}
