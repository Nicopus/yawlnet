...
public class PetrinetElementTypes {
	...
	*/
	public static final IElementType Petrinet_1000 = getElementType(
			"dk.dtu.compute.se.mdsu.tutorial1.diagram.Petrinet_1000"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Transition_2001 = getElementType(
			"dk.dtu.compute.se.mdsu.tutorial1.diagram.Transition_2001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Place_2002 = getElementType("dk.dtu.compute.se.mdsu.tutorial1.diagram.Place_2002"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Token_3001 = getElementType("dk.dtu.compute.se.mdsu.tutorial1.diagram.Token_3001"); //$NON-NLS-1$
	/**
	* @generated
	*/
	public static final IElementType Arc_4001 = getElementType("dk.dtu.compute.se.mdsu.tutorial1.diagram.Arc_4001"); //$NON-NLS-1$
	...
	public static final DiagramElementTypes TYPED_INSTANCE = new DiagramElementTypes(elementTypeImages) {
		...
		*/
		...
		public boolean isKnownElementType(IElementType elementType) {
			return dk.dtu.compute.se.mdsu.petrinet.diagram.providers.PetrinetElementTypes
		...
		*/
		...
		public IElementType getElementTypeForVisualId(int visualID) {
			return dk.dtu.compute.se.mdsu.petrinet.diagram.providers.PetrinetElementTypes.getElementType(visualID);
		}
