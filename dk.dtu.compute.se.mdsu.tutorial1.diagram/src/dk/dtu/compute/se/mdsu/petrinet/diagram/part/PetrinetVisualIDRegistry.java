...
import dk.dtu.compute.se.mdsu.petrinet.diagram.edit.parts.PlaceEditPart;
import dk.dtu.compute.se.mdsu.petrinet.diagram.edit.parts.PlaceNameEditPart;
import dk.dtu.compute.se.mdsu.petrinet.diagram.edit.parts.TokenEditPart;
import dk.dtu.compute.se.mdsu.petrinet.diagram.edit.parts.TransitionEditPart;
import dk.dtu.compute.se.mdsu.petrinet.diagram.edit.parts.TransitionNameEditPart;
...
public class PetrinetVisualIDRegistry {
	...
	* @generated
	*/
	private static final String DEBUG_KEY = "dk.dtu.compute.se.mdsu.tutorial1.diagram/debug/visualID"; //$NON-NLS-1$
	...
	*/
	public static int getVisualID(View view) {
		...
		return dk.dtu.compute.se.mdsu.petrinet.diagram.part.PetrinetVisualIDRegistry.getVisualID(view.getType());
	}
	...
	*/
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = dk.dtu.compute.se.mdsu.petrinet.diagram.part.PetrinetVisualIDRegistry
		...
		if (PetrinetEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = dk.dtu.compute.se.mdsu.petrinet.diagram.part.PetrinetVisualIDRegistry
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		*/
		...
		public int getVisualID(View view) {
			return dk.dtu.compute.se.mdsu.petrinet.diagram.part.PetrinetVisualIDRegistry.getVisualID(view);
		}
		...
		*/
		...
		public String getModelID(View view) {
			return dk.dtu.compute.se.mdsu.petrinet.diagram.part.PetrinetVisualIDRegistry.getModelID(view);
		}
		...
		*/
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return dk.dtu.compute.se.mdsu.petrinet.diagram.part.PetrinetVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		}
		...
		*/
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return dk.dtu.compute.se.mdsu.petrinet.diagram.part.PetrinetVisualIDRegistry
